...
public class CompletionInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String offset = req.getParameter("index");
		...
		String url = eclipse_server + "/completion?project=" + projectname + "&index=" + offset;
